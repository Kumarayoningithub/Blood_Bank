        ...
        <>
            ...
            <div id='about' className='about_bg'>
                <div id='about_bg'>
                    <div>
                        <h2>About Us</h2>
                        <h3>Welcome to RedReserve, a platform dedicated to saving lives through blood donation.</h3> 
                    </div>
                ...
                <div className='about_content' id='about_content_top'>
                    <div className='img_text_about'>
                        ...
                        <div id='text'>
                            <h3>Our Mission:</h3>
                            <p>At RedReserve, our mission is simple yet profound: to bridge the gap between blood donors and those in need, ensuring a reliable and sustainable blood supply for hospitals and communities worldwide. We believe that every drop of blood donated has the power to make a difference and save lives.</p>
                            <h3>Who We Are:</h3>
                            <p>RedReserve was founded by a team of passionate individuals committed to making a positive impact on society. With backgrounds in healthcare, technology, and community service, we came together with a shared vision of leveraging technology to streamline the blood donation process and inspire more people to become blood donors.</p>
                            <h3>What We Do:</h3>
                ...
                <div className='about_content about_content2 '>
                    <div className='img_text_about'>
                        <div id='img'>
                            <img src='/assets/images/fifth.jpg' alt="" />
                        </div>
                ...
                <div className="about_card">
                    ...
                    <div>
                        ...
                        <p id="blog">Share your organization's vision for the future and outline strategic goals and initiatives aimed at furthering your impact. Invite stakeholders to join you on this journey toward a healthier, more equitable world.</p>
                    </div>
